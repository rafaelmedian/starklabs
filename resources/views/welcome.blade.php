...
<header class="w-100 bg-white bg-right pv3" style="background-image: url('{{secure_url('dist/img/shape-hero.svg')}}')">
    ...
    <div class="db dt mw8 center w-100 ph3 ph2-l" >
        <div class="fl bt3 pb4-ns pt4 mt4 w-50-l">
            ...
            <div class="tc tl-l">
                <a href="{{ secure_url('/bot/') }}" class="grow f6 f5-ns dib br-pill ba ph4 pv2 cta">Let us build your bot <img class="ml2 v-mid" height="19px" src="{{ secure_asset('/dist/img/r-arrow.svg')}}" alt="cta"></a>
            </div>
        </div>
        <div class="fr w-50-l pa4">
            <img src="{{ secure_asset('/dist/img/hero-robot@2x.png')}}" alt="hero robot">
        </div>
    </div>
</header>
    ...
    <div class="cf ph2-ns">
        <div class="fl w-100 w-third-ns pa2">
            <div class="tc bg-white pv4 ph2">
                <img src="{{ secure_asset('/dist/img/built-a-mbot@2x.jpg')}}" alt="Built a Messenger Bot Image">
        ...
        <div class="fl w-100 w-third-ns pa2">
            <div class="tc bg-white pv4 ph2">
                <img src="{{ secure_asset('/dist/img/bot-2.svg')}}" alt="Personal Assistant Bot Image">
        ...
        <div class="fl w-100 w-third-ns pa2">
            <div class="tc bg-white pv4 ph2">
                <img src="{{ secure_asset('/dist/img/statsworkflow.svg')}}" alt="stats">
...
<section class="mw8 center">
    <article class="ph3 ph0-1">
        <div class="flex flex-column flex-row-ns">
            <div class="w-100 w-50-ns pr4-ns order-2 order-1-ns pv6-l">
                ...
                <a href="{{ secure_url('/bot/') }}" class=" grow f6 f5-ns tc-m dib br-pill ba ph4 pv2 cta">Build a chatbot <img class="ml2 v-mid" height="19px" src="{{ secure_url('/dist/img/r-arrow.svg')}}" alt="cta"></a>
            </div>
    ...
    <article class="ph3 ph0-1">
        <div class="flex flex-column flex-row-ns">
            <div class="pl3-ns order-1 order-2-ns mb4 mb0-ns w-100 w-50-ns">
                <img src="{{ secure_asset('/dist/img/workflow@2x.jpg')}}" alt="">
            </div>
            <div class="w-100 w-50-ns pl4-ns order-1 order-2-ns pv6-l">
                ...
                <a href="{{ secure_url('/bot/') }}" class="grow f6 f5-ns tc-m dib br-pill ba ph4 pv2 cta">Get a workflow <img class="ml2 v-mid" height="19px" src="{{ secure_asset('dist/img/r-arrow.svg')}}" alt="cta"></a>
