...
<header class="w-100 bg-white bg-right pv3" style="background-image: url(dist/img/shape-hero.svg)">
    ...
    <div class="db dt mw8 center w-100 ph3 ph2-l" >
        <div class="fl bt3 pb4-ns pt4 mt4 w-50-l">
            ...
            <div class="tc tl-l">
                <a href="{{ url ('/bot/') }}" class="f6 f5-ns dib br-pill ba ph4 pv2 cta">Let us build your bot <img class="ml2" src="dist/img/r-arrow.svg" alt=""></a>
            </div>
        </div>
    ...
    <article class="ph3 ph0-1">
        <div class="flex flex-column flex-row-ns">
            <div class="w-100 w-50-ns pr4-ns order-2 order-1-ns pv6-l">
                ...
                <a href="{{ url ('/bot/') }}" class="f6 f5-ns tc-m dib br-pill ba ph4 pv2 cta">Build a chatbot <img class="ml2" src="dist/img/r-arrow.svg" alt=""></a>
            </div>
    ...
    <article class="ph3 ph0-1">
        <div class="flex flex-column flex-row-ns">
            ...
            <div class="w-100 w-50-ns pl4-ns order-1 order-2-ns pv6-l">
                ...
                <a href="{{ url ('/bot/') }}" class="f6 f5-ns tc-m dib br-pill ba ph4 pv2 cta">Get a workflow <img class="ml2" src="dist/img/r-arrow.svg" alt=""></a>
